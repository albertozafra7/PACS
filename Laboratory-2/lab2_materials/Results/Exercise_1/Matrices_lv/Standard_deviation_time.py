...
with open('times_lv_clock_filtered.txt', 'r') as file1:
...
with open('times_lv_clock_filtered_1.txt', 'r') as file2:
...
with open('times_lv_clock_filtered_1.txt', 'r') as file3:
...
with open('matrices_lv_clock.csv', 'r') as file4:
