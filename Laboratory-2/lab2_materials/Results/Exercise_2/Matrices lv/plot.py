...
with open('average_time_matrices_lv_getime.txt', 'r') as file2:
...
plt.plot(data1_x, data2_y, label='time user')
plt.plot(data1_x, data2_z, label='time system')
plt.plot(data1_x, data2_w, label='time elapsed')
